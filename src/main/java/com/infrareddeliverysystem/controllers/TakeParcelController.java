...
public class TakeParcelController {
    ...
    public void goTakeParcelNextPage(ActionEvent event) throws IOException {
        ...
        double we = parseDouble(weight.getText());
        String sp = senderName.getText();
        String spt = senderPhone.getText();
        String rp = receiverName.getText();
        String rpt = receiverPhone.getText();
        String raddr = receiverAddress.getText();

        parcel.setParcelDescription(des);
        parcel.setParcelType(ty);
        parcel.setWeight(we);
        parcel.setSenderName(sp);
        parcel.setSenderPhone(spt);
        parcel.setReceiverName(rp);
        parcel.setReceiverPhone(rpt);
        parcel.setReceiverAddress(raddr);
...
//        System.out.println("Description: " + description + "\nType: " + type + "\nWeight: " + weight);
        ...
        TakeParcelNextController nextController = loader.getController();
        nextController.setParcel(parcel);
