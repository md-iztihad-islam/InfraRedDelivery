...
public class Welcometochatrider {
    ...
    @FXML
    private void onChatNow(ActionEvent event) throws Exception {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/infrareddeliverysystem/fxml/chatRider.fxml"));
        Parent root = loader.load();
        com.infrareddeliverysystem.controllers.ChatRider chatController = loader.getController();
        chatController.setIDs(parcelID, deliveryManId);

        Stage stage = (Stage) chatNowButton.getScene().getWindow();
